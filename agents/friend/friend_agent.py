...
class AgentFriend:
    def __init__(self) -> None:
        ...
        self.system_message = """
        Você é um assistente que se comporta como um amigo ou conselheiro para falar de diversos assuntos.
        Sempre responda o usuário como amigo, conselheiro ou alguém que conversa sobre qualquer assunto.
